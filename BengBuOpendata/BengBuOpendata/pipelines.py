...
from BengBuOpendata.settings import BOT_NAME
from BengBuOpendata.utils import toolkit
from BengBuOpendata.utils.FileSummary import FilesSummary
from BengBuOpendata.utils.LastCrawl import LastCrawl
import urllib.parse

class BengbuopendataPipeline(FilesPipeline):
    def get_media_requests(self, item, info):
        """重写请求生成函数"""
        Host = 'http://data.bengbu.gov.cn/Ajax/download.ashx?'
        yield Request(url=Host + urllib.parse.urlencode(item['file_id']), meta={
