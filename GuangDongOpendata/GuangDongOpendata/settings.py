...
import socket
# 工程名
BOT_NAME = 'GuangDongOpendata'
SPIDER_MODULES = ['GuangDongOpendata.spiders']
NEWSPIDER_MODULE = 'GuangDongOpendata.spiders'
...
ITEM_PIPELINES = {
   'GuangDongOpendata.pipelines.KaiFangGuangDongPipeline': 300,
}
